...
* **Responsive Layout:** Adaptive styling with a sticky navigation bar designed using Flexbox and CSS media queries[cite: 1, 3].
* **Local API Setup:** Features a `db.json` database structure ready to mock real POST/GET server requests[cite: 2, 3].
